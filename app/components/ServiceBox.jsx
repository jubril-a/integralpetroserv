  ...
  return (
    <div className={styles.expanded}>
        <div className={styles.serviceBox}>
            <Image src="/images/close.png" width="20" height="20" alt="menu" className={styles.serviceImg} onClick={clickHandler} style={{marginLeft: 'auto', marginBottom: '2rem', display: 'block'}}/>
