  ...
  return (
    <div className={styles.expanded}>
        <div className={styles.serviceBox}>
            <Image src="/images/close.png" width="26" height="26" alt="menu" className={styles.serviceImg} onClick={clickHandler} style={{marginLeft: 'auto', marginBottom: '2rem', display: 'block'}}/>
