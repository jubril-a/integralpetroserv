  ...
  return (
    <section className={`${styles.Wrapper} constraint-I`}>
      <div className={`${styles.mnv} ${styles.grid}`}>
          <div>
            <Image src="/images/target.png" alt="" width={56} height={56}></Image>
          ...
          <div>
            <Image src="/images/visionary.png" alt="" width={56} height={56}></Image>
      ...
      <Image src="/images/quality.png" alt="" width={56} height={56}></Image>
